-- ============================================================================
-- AssetWorx Default Account Diagnostics
-- Run against: AssetWorx database on .\sqlexpress
...
--    logged into AssetWorx. If superadmin is on Company 3 but a new user
...
--     Use iDash User Management > AssetWorx tab > Edit > set new password.
--     Or use the CreateAwUserInternal method which generates proper V3 SHA256 hash.
