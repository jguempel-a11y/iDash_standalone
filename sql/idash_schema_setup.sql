...
BEGIN
    ...
    [lastrfidserialnumber] int NOT NULL DEFAULT ((1)),
    [temperatureformat] varchar(50) NULL DEFAULT ('Fahrenheit'),
    [lastmodifiedby] varchar(50) NULL,
    [usemeters] bit NULL DEFAULT ((0)),
    [assetdisplaycolumns] varchar(5000) NULL DEFAULT ('name,vTagID,rfidTag,locationName,description,created'),
    [vtagpopupdisplayrows] varchar(5000) NULL DEFAULT ('name,vTagID,vTagLastSeen,batteryLevel,description'),
    [cmdmaprefresh] int NULL DEFAULT ((15)),
    [cmdactivetimeout] int NULL DEFAULT ((75)),
    [eventtrim] int NULL DEFAULT ((7)),
    [alarmtrim] int NULL DEFAULT ((30)),
    [sensorreadingtrim] int NULL DEFAULT ((30)),
    [locationhistorytrim] int NULL DEFAULT ((90)),
    [commandtrim] int NULL DEFAULT ((365)),
    [sensorstattrim] int NULL DEFAULT ((30)),
    [smtpemailenablessl] bit NULL DEFAULT ((0)),
    [smtpemailfrom] varchar(5000) NULL,
    [smtpemailhost] varchar(5000) NULL,
    [smtpemailpassword] varchar(5000) NULL,
    [smtpemailport] int NULL DEFAULT ((25)),
    [smtpemailto] varchar(5000) NULL,
    [smtpemailusername] varchar(5000) NULL,
    [dateformat] varchar(50) NULL,
    [vtagpositionreportingmode] varchar(50) NULL,
    [alarmunassociatedassets] bit NULL,
    [vtaggpsserveraddress] varchar(100) NULL,
    [vtaggpsserverport] int NULL,
    [vtaggpsserverusername] varchar(100) NULL,
    [vtaggpsserverpassword] varchar(100) NULL,
    [cmdmappinzoominenabled] bit NULL DEFAULT ((0)),
    [cmdmappindisplacepixels] int NULL,
    [automaticallyserializeassetname] bit NULL,
    [assetnameserialprefix] varchar(50) NULL,
    [assetnameseriallength] int NULL,
    [currentassetnameserial] int NULL,
    [twofactorauthenabled] bit NULL,
    [authenticationserver] varchar(5000) NULL,
    [emailmethod] varchar(100) NULL,
    [emailcloudusername] varchar(200) NULL,
    [emailcloudpassword] varchar(500) NULL,
    [mqttenabled] bit NULL,
    [mqttlocation] varchar(100) NULL,
    [mqttusername] varchar(100) NULL,
    [mqttpassword] varchar(100) NULL,
    [authenticationserverusesjwt] bit NULL,
    [introspectthumbprint] varchar(500) NULL,
    [webclientid] varchar(5000) NULL,
    [webclientsecret] varchar(5000) NULL,
    [mobileclientid] varchar(5000) NULL,
    [mobileclientsecret] varchar(5000) NULL,
    [webclientuselocalstorage] bit NULL,
    [enableassetunseen] bit NULL,
    [enableglobaleventmessages] bit NULL,
    [enableglobalalarmmessages] bit NULL,
    [enableglobalgatewaymessages] bit NULL,
    [enableglobalsensorreadingmessages] bit NULL,
    [enableglobaltagmovementmessages] bit NULL,
    [enableglobaltagobservationmessages] bit NULL,
    [updatelastinventoriedformovedassets] bit NULL,
    [fixedtagsmovetodiffmap] bit NULL,
    [defaultcheckoutlocationid] int NULL,
    [defaultcheckinlocationid] int NULL,
    [audittrim] int NULL,
